...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.zed_channel_selectio_wiz_0_0 xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.zed_channel_selectio_wiz_0_0 -input simulate.do
}
# Script usage
usage()
{
