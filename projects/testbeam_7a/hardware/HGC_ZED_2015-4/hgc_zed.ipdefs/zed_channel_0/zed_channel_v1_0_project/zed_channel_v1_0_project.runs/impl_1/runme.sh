...
HD_PWD='/home/jlow/Work/Vivado/testbeam_7a/HGC_ZED_0/hgc_zed/hgc_zed.srcs/sources_1/bd/zed_channel/zed_channel_v1_0_project/zed_channel_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_channel.vdi -applog -m64 -messageDb vivado.pb -mode batch -source zed_channel.tcl -notrace
