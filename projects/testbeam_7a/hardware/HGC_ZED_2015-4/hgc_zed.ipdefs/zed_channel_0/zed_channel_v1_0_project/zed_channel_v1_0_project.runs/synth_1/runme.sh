...
HD_PWD='/home/jlow/Work/Vivado/testbeam_7a/HGC_ZED_0/hgc_zed/hgc_zed.srcs/sources_1/bd/zed_channel/zed_channel_v1_0_project/zed_channel_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zed_channel.vds -m64 -mode batch -messageDb vivado.pb -notrace -source zed_channel.tcl
