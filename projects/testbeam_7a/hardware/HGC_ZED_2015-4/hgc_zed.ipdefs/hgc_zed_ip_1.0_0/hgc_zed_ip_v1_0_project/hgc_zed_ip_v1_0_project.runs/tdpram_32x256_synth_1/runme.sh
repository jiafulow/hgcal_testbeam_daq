...
HD_PWD='/home/jlow/Work/Vivado/testbeam_7a/HGC_ZED_0/ip_repo/hgc_zed_ip_1.0/hgc_zed_ip_v1_0_project/hgc_zed_ip_v1_0_project.runs/tdpram_32x256_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tdpram_32x256.vds -m64 -mode batch -messageDb vivado.pb -notrace -source tdpram_32x256.tcl
