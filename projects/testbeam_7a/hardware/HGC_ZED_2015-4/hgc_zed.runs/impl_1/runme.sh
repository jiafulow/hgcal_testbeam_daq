...
HD_PWD='/home/jlow/Work/Vivado/testbeam_7a/HGC_ZED_0/hgc_zed/hgc_zed.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source top_wrapper.tcl -notrace
