...
HD_PWD='/home/jlow/Work/Vivado/testbeam_7a/HGC_ZED_0/hgc_zed/hgc_zed.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_wrapper.tcl
