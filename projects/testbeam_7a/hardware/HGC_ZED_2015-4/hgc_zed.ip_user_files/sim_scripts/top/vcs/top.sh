...
elaborate()
{
  opts="-load "/opt/Xilinx/Vivado/2015.4/lib/lnx64.o/libxil_vcs.so:xilinx_register_systf" -full64 -debug_pp -t ps -licqueue -l elaborate.log"

  vcs $opts xil_defaultlib.top xil_defaultlib.glbl -o top_simv
}
